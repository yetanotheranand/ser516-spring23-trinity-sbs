...
fdescribe('TaskComponent', () => {
  ...
  it('should display the task subject and description', () => {
    ...
    expect(subjectElement.nativeElement.textContent).toBe(component.task.subject);
    expect(descriptionElement.nativeElement.textContent).toBe(component.task.description);
  });

  it('should display the assigned user', () => {
    const assignedToElement = fixture.debugElement.query(By.css('#assignedTo'));

    expect(assignedToElement.nativeElement.textContent).toBe(component.task.assignedTo);
  });
