...
fdescribe('CardComponent', () => {
  ...
  it('should display the correct project name and description', () => {
    ...
    for (let i = 0; i < component.projects.length; i++) {
      const projectName = projectEls[i].querySelector('mat-card-title').textContent;
      const projectDescription = projectEls[i].querySelector('mat-card-subtitle').textContent;
